...
mkdir inner-loop-vol-parent-test-dir
cd inner-loop-vol-parent-test-dir

echo -e "\n> Clone application-stack-samples project"
git clone https://github.com/OpenLiberty/application-stack-samples.git

echo -e "\n> Clone application-stack-intro project"
git clone --branch appStackIntroGradle https://github.com/OpenLiberty/application-stack-intro.git
cd application-stack-intro

echo -e "\n> Copy the devfile using parent and volume settings, and update the stack image with the one built"
cp ../application-stack-samples/devfiles/gradle-volume-parent/devfile.yaml devfile.yaml
...
cd ../../; rm -rf inner-loop-vol-parent-test-dir